    ...
    <form name="form" id="js-form" onSubmit={props.addTodoList} >
      <div className="form-group row">
        ...
        <div className="col-sm-10">
          <input name="todo" id="todo" value={props.todoItem.title} onChange={props.getTitle}className="form-control" type="text" />
        </div>
      </div>
      <div className="form-group row">
      ...
      <div className="form-group row">
        ...
        <div className="col-10 mt-2">
          <label><input type="radio" name="importance" value="高" checked={props.todoItem.importance === '高'} onChange={props.getImportance}/>高</label>
          <label><input type="radio" name="importance" value="中" checked={props.todoItem.importance === '中'} onChange={props.getImportance} className="ml-5"/>中</label>
          <label><input type="radio" name="importance" value="低" checked={props.todoItem.importance === '低'} onChange={props.getImportance} className="ml-5"/>低</label>
        </div>
      </div>
